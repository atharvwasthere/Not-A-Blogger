...
export function ImageUpload({ value, onChange, className }: ImageUploadProps) {
    ...
    if (value) {
        return (
            <div className={cn("relative group rounded-lg overflow-hidden border border-zinc-200 aspect-video w-full bg-[url('https://www.transparenttextures.com/patterns/checkerboard.png')] bg-repeat", className)}>
                <img
                    src={value}
                    alt="Cover preview"
