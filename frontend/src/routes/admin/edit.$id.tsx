...
export const Route = createFileRoute('/admin/edit/$id')({
  loader: async ({ params }) => {
    return api.getPostById(params.id)
  },
...
function EditPost() {
  ...
  const [postStatus, setPostStatus] = useState<'Draft' | 'Published'>(post.is_published ? 'Published' : 'Draft')
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_350px] min-h-[calc(100vh-56px)]">
      ...
      <aside className="border-l border-zinc-100 bg-zinc-50/30 p-8 flex flex-col gap-10 lg:sticky lg:top-[56px] lg:h-[calc(100vh-56px)] overflow-y-auto">
        ...
        <div className="space-y-4">
          <h3 className="font-serif text-xl text-zinc-900">Post</h3>
